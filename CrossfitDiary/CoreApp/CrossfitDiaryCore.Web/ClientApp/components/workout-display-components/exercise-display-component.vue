<template>
    <div>
        ...
        >(unbroken)</span>
            ...
            <span v-if="model.weightMeasure && model.weightMeasure.measureValue"> x {{model.weightMeasure.measureValue}} kgs</span>
            <span v-if="model.altWeightMeasure && model.altWeightMeasure.measureValue">/ {{model.altWeightMeasure.measureValue}} kgs</span>
