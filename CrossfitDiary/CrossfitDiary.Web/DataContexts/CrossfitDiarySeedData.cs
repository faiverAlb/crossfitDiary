...
namespace CrossfitDiary.DAL.EF
{
    public class CrossfitDiarySeedData : DropCreateDatabaseAlways<CrossfitDiaryEntities>
    {
        protected override void Seed(CrossfitDiaryEntities context)
        {
        ...
        private static List<Exercise> GetInitialExercises(CrossfitDiaryEntities context)
        {
        ...
        private static List<RoutineComplex> GetInitialRoutines(CrossfitDiaryEntities context)
        {
        ...
        private static List<CrossfitterWorkout> GetInitialCrossfitterWorkout(CrossfitDiaryEntities context)
        {
